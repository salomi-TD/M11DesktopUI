<template>
  <div>
    <div class="content">
      ...
      <div class="container">
        <div class="cards-container7">
          <div v-for="item in workflowList" :key="item.workFlowId" class="card11">
...
axios.get(`http://localhost:8082/fbo/list/${this.empId}`);
...
.card11 {
  ...
  width: calc(33.33% - 20px); /* Adjust the width to ensure spacing */
  margin-bottom: 20px;
